...
C ==========================================================================
      FUNCTION ALPHAS(QMM)
C ==========================================================================
cpn2006 Returns the strong coupling strength evaluated at the 
c     THE square of the FACTORIZATION SCALE Q
      IMPLICIT NONE
      double precision QMM,alpi, alphas, pi
      DATA PI /3.1415 92653 58979 32384 62643/

      
      alphas=alpi(sqrt(QMM))*pi
